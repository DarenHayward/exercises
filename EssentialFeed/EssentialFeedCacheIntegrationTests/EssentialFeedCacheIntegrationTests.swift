...
//
//  Created by Daren Hayward on 02/03/2022.
//
...
class EssentialFeedCacheIntegrationTests: XCTestCase {
    ...
    func test_loadFeedLoader_deliversNoItemsOnEmptyCache() {
        let sut = makeFeedLoader()

        expect(sut, toLoad: [])
    }

    func test_loadFeedLoader_deliversItemsSavedOnASeparateInstance() {
    ...
    func test_saveFeedLoader_overridesItemsSavedOnASeparateInstance() {
